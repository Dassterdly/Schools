    ...
    public partial class frmStudentAssessments : Form
    {
        ...
        public void loadassessments()
        {
            ...
            var classAssign = from a in db.Assessments
                              ...
                              select new
                              {
                                  AcademicTerm = a.StudentClass.Class.AcademicYear,
                                  Term = a.StudentClass.Class.Term.TermName,
                                  Subject = a.StudentClass.Class.Subject.SubjectName,
