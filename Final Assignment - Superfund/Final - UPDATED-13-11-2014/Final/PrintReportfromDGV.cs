        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                if (dlg.ShowDialog() == DialogResult.Cancel) return;
                    ...
                    PrintTitle = "Student Classes Report";
                    ...
                    System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewColumn GridCol in dgv.Columns)
                {
                    ...
                    if (!PrintReportfromDGV.SelectedColumns.Contains(GridCol.HeaderText)) continue;
                    ...
                    else
                    {
                        if (NewPage)
                        {
                           ...
                           e.Graphics.DrawString(s, new Font(dgv.Font, FontStyle.Bold),
                            ...
                            {
                                if (!GridCol.Visible) continue;
                                if (!PrintReportfromDGV.SelectedColumns.Contains(GridCol.HeaderText))
                                    continue;
