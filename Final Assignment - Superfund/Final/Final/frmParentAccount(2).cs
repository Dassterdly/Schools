    ...
    public partial class frmParentAccount : Form
    {
        ...
        private void LoadChildren(int uID)
        {
            var qchild = from p in db.Parents
                         ...
                         select new { FirstName = s.SFirstName, LastName = s.SLastName, School = sch.SchoolName, Admission = s.AdmissionDat, Graduation = s.ExpectedGraduationDate, Userid = s.UserID };
